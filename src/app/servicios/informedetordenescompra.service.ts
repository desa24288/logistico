...
@Injectable()
export class InformedetordenescompraService {
    public urlinfajuste      : string = environment.URLServiciosRest.URLConexionInformes.concat('/obtieneurlinfdetalleordencompra');//"http://172.25.108.236:8194/obtieneurlinfajustesprecios";
    ...
    RPTInfDetalleOC(tiporeport: string, tipoprod:string,fechaini:string,fechafin:string,
        hdgcodigo:number,esacodigo:number,cmecodigo:number):Observable<UrlReporte[]> {

        return this._http.post<UrlReporte[]>(this.urlinfajuste, {
