...
export class InformedetordenescompraService {
    public urlinfajuste      : string = sessionStorage.getItem('enlace').toString().concat('/obtieneurlinfdetalleordencompra');//"http://172.25.108.236:8194/obtieneurlinfajustesprecios";
