...
export class InfdevolucioncomprasService {
    public urldevolcompras : string = environment.URLServiciosRest.URLConexionInformes.concat('/obtieneurlinfdevolucioncompras');//"http://172.25.108.236:8194/obtieneurlinfajustesprecios";
