...
export class InfdoctosingresadosService {
    public urldoctoing     : string = sessionStorage.getItem('enlace').toString().concat('/obtieneurlinfdocumentosingresados');//"http://172.25.108.236:8194/obtieneurlinfajustesprecios";
