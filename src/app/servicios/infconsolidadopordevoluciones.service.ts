...
@Injectable()
export class InfconsolidadopordevolucionesService {
    public urlconsumo       :string= environment.URLServiciosRest.URLConexionInformes.concat('/obtieneurlinfconsolidadodevoluciones');//"http://172.25.108.236:8194/obtieneurlinfconsumobodegavalo";
    ...
    RPTInfConsolidadoDevoluciones(tiporeport: string,tiporeg:string, tipoprod:string,fechaini:string,
