...
export class InfconsolidadopordevolucionesService {
    public urlconsumo       :string= sessionStorage.getItem('enlace').toString().concat('/obtieneurlinfconsolidadodevoluciones');//"http://172.25.108.236:8194/obtieneurlinfconsumobodegavalo";
