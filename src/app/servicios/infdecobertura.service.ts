...
@Injectable()
export class InformeCoberturaService {
    public urlinfcobertura   : string = environment.URLServiciosRest.URLConexionInformes.concat('/obtieneurlinfcoberturageneral');//"http://172.25.108.236:8194/obtieneurlinfajustesprecios";
    ...
    RPTInfCobertura(tiporeport: string, tipoprod:string,fechaini:string,fechafin:string,
        hdgcodigo:number,esacodigo:number,cmecodigo:number):Observable<UrlReporte[]> {

        return this._http.post<UrlReporte[]>(this.urlinfcobertura, {
