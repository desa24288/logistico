...
export class InformeCoberturaService {
    public urlinfcobertura   : string = sessionStorage.getItem('enlace').toString().concat('/obtieneurlinfcoberturageneral');//"http://172.25.108.236:8194/obtieneurlinfajustesprecios";
