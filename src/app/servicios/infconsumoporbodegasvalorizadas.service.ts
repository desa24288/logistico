...
export class InfconsumoporbodegasvalorizadasService {
    public urlconsumo       :string= environment.URLServiciosRest.URLConexionInformes.concat('/obtieneurlinfconsumobodegavalo');//"http://172.25.108.236:8194/obtieneurlinfconsumobodegavalo";
