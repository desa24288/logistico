...
@Injectable()
export class InfordenescompraanuladaService {
    public urlordenesanulada: string = environment.URLServiciosRest.URLConexionInformes.concat('/obtieneurlinfordencompraanulada');//"http://172.25.108.236:8194/obtieneurlinfajustesprecios";
    ...
    RPTInfOrdnesCompraAnulada(tiporeport: string,hdgcodigo:number,esacodigo:number,cmecodigo:number):Observable<UrlReporte[]> {
    
        return this._http.post<UrlReporte[]>(this.urlordenesanulada, {
