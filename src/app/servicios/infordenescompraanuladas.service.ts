...
export class InfordenescompraanuladaService {
    public urlordenesanulada: string = sessionStorage.getItem('enlace').toString().concat('/obtieneurlinfordencompraanulada');//"http://172.25.108.236:8194/obtieneurlinfajustesprecios";
