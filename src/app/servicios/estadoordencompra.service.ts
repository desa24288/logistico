...
export class InfEstadoordencompraService {
    public urlconsumo       :string= sessionStorage.getItem('enlace').toString().concat('/obtieneurlinfestadoordencompra');//"http://172.25.108.236:8194/obtieneurlinfconsumobodegavalo";
