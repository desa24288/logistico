...
export class InftendenciasconsumoService {
    public urlconsumo       :string= sessionStorage.getItem('enlace').toString().concat('/obtieneurlinftendenciaconsumo');//"http://172.25.108.236:8194/obtieneurlinfconsumobodegavalo";
