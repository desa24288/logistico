...
@Injectable()
export class InftendenciasconsumoService {
    public urlconsumo       :string= environment.URLServiciosRest.URLConexionInformes.concat('/obtieneurlinftendenciaconsumo');//"http://172.25.108.236:8194/obtieneurlinfconsumobodegavalo";
