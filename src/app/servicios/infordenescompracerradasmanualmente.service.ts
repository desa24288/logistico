...
export class InfordenescompracerradasmanualmenteService {
    public urlordenes      : string = sessionStorage.getItem('enlace').toString().concat('/obtieneurlinfordencompracerradaman');//"http://172.25.108.236:8194/obtieneurlinfajustesprecios";
