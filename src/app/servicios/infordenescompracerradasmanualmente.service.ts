...
@Injectable()
export class InfordenescompracerradasmanualmenteService {
    public urlordenes      : string = environment.URLServiciosRest.URLConexionInformes.concat('/obtieneurlinfordencompracerradaman');//"http://172.25.108.236:8194/obtieneurlinfajustesprecios";
    ...
    RPTInfOrdenesCerradasManualmente(tiporeport: string,hdgcodigo:number,esacodigo:number,cmecodigo:number):Observable<UrlReporte[]> {
