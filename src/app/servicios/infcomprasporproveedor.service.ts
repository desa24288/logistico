...
@Injectable()
export class InfcomprasporproveedorService {
    public urlcompras       :string= environment.URLServiciosRest.URLConexionInformes.concat('/obtieneurlinfcomprasproveedor');//"http://172.25.108.236:8194/obtieneurlinfconsumobodegavalo";
    ...
    RPTInfComprasProv(tiporeport: string,rutprov:string,fechaini:string,fechafin:string,
        hdgcodigo:number,esacodigo:number,cmecodigo:number):Observable<UrlReporte[]> {
      
        return this._http.post<UrlReporte[]>(this.urlcompras, {
