...
export class InfcomprasporproveedorService {
    public urlcompras       :string= sessionStorage.getItem('enlace').toString().concat('/obtieneurlinfcomprasproveedor');//"http://172.25.108.236:8194/obtieneurlinfconsumobodegavalo";
