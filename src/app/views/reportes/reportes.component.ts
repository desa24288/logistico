...
export class ReportesComponent implements OnInit {
  ...
  SeleccionaTipoSolicitud(tiposolicitud:number){
    console.log("tipo solici",tiposolicitud)
    if(tiposolicitud == 0){
      ...
      // this.activasolicitud = false;
      this.tiporeporte = true;
      // this.activatiporeporte = true;
    }
    if(tiposolicitud == 1){
      this.activabtnbuscar = true;
  ...
  getSolicitud(solicitud: any,tiposolicitud:number, solic:number) {
    ...
    if(this.solicitud >0){
      if(tiposolicitud == 0){
        console.log("busca solicitudes de bodegas",this.solicitud)
            ...
            response => {
              if (response != null) {
                if(response.length==0){
                  this.alertSwalError.title = "No existe la solicitud buscada";
        ...
        if(tiposolicitud == 1){
          console.log("busca solicitudes de pacientes")
            ...
            0, 3, 0, 0, 0, 0, null,0,"","").subscribe((Retorno: any) => {
              if(Retorno.length ==0){
                ...
                if (Retorno !== undefined) {
                  ...
                  this.loading = false;
                  console.log("Solicitud buscada PACIENTE", Retorno);
  ...
  ImprimirSolicitud() {
    console.log(this.FormReportes.value.tiporeporte)
    switch (parseInt(this.FormReportes.value.tiporeporte)) {
      ...
      case 6:
          ...
          this.esacodigo,this.cmecodigo, "pdf", this.FormReportes.value.numsolicitud,3).subscribe(
              ...
              break;
      case 7:
          this.alertSwalError.title = "Error al Imprimir Rececpción Devolución Solicitud Paciente";
          this.alertSwalError.show();
      break;
      case 8:
